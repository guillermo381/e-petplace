...
export { obtenerMiSaldo, pagarCompraConSaldo } from './wrappers/postventa-saldo';
export type { PagoConSaldo, CodigoPagoSaldo, ErrorPagoSaldo } from './wrappers/postventa-saldo';
