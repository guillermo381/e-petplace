...
export const clienteEs = {
  ...
  nexo: {
    ...
    memoriaTituloSinNombre: 'Lo que sé de tu mascota',
  ...
  hogar: {
    ...
    hechoPeso: 'Lo pesaron',
    hechoAlergia: 'Le encontraron una alergia',
    hechoComportamiento: 'Anotaron algo de su comportamiento',
    hechoMedicacion: 'Le recetaron un medicamento',
    hechoCaso: 'Le abrieron un caso clínico',
    hechoDesparasitacion: 'Lo desparasitaron',
    hechoProducto: 'Le asignaron un producto',
    hechoExamen: 'Le pidieron un examen',
    hechoFinVida: '{{nombre}} se despidió',
  ...
  perfil: {
    ...
    razaMasSobre: 'Más sobre el {{raza}}',
    razaVer: 'Su carácter, su tamaño y sus cuidados',
    razaOcultar: 'Ocultar',
    seguridadVer: 'Ver {{n}}',
    ...
    pastillaEnMemoria: 'En memoria',
    edadTenia: 'tenía {{edad}}',
    ...
    tableroDelPlanAlDia: '{{n}} de {{total}} al día',
    tableroVencidaHace: 'vencida desde el {{fecha}}',
    ...
    conociendoloCompleto: 'Ya conocemos a {{nombre}} casi como tú.',
    conociendoloMas: 'Cuéntanos más de {{nombre}}',
  ...
  planVacunas: {
    planTitulo: 'Su plan',
    planObligatoria: 'Obligatoria',
    planOpcional: 'Opcional',
    planDerivada: 'Según su plan, tocaría el {{fecha}}',
    planSinClasificar: 'Hay {{n}} vacunas en su carnet que no pudimos ubicar en el plan.',
    estadoAlDia: 'Al día',
    estadoVenceEn: 'Vence en {{n}} días',
    estadoVencida: 'Venció hace {{n}} días',
    estadoSinFecha: 'No sabemos cuándo toca la próxima',
    estadoNunca: 'No figura en su carnet',
    estadoAunNo: 'Todavía no le toca',
    estadoDesconocido: 'No pudimos clasificarla',
    lote: 'Lote',
    laboratorio: 'Laboratorio',
    via: 'Vía',
    vencimientoBiologico: 'Vence el frasco',
    aplicadaPor: 'Se la aplicó',
  ...
  servicioVoz: {
    consultaEspecializada: 'Consulta especializada',
  ...
  postular: {
    ...
    hogarRotulo: '¿Quiénes viven en casa?',
    hogarAdultos: 'Adultos',
    hogarMenores05: 'Niños de 0 a 5',
    hogarMenores612: 'Niños de 6 a 12',
    hogarMenores1317: 'Adolescentes de 13 a 17',
    viviendaRotulo: '¿Cómo es tu casa?',
    vivienda_casa_con_patio: 'Casa con patio',
    vivienda_casa_sin_patio: 'Casa sin patio',
    vivienda_departamento: 'Departamento',
    vivienda_otro: 'Otro',
    otrosAnimalesRotulo: '¿Vive algún otro animal contigo?',
    otrosAnimalesAyuda: 'Cuáles y cuántos. Si no hay ninguno, déjalo vacío.',
    horasSoloRotulo: '¿Cuántas horas al día estaría solo?',
    horasSoloAyuda: 'Un número aproximado alcanza.',
    experienciaRotulo: '¿Tuviste animales antes?',
    experienciaAyuda: 'Cuenta lo que quieras: no hay respuesta correcta.',
    motivoRotulo: '¿Por qué este animal?',
    motivoAyuda: 'Es lo que el refugio más lee.',
    enviar: 'Enviar mi postulación',
    faltaAdultos: 'Tiene que vivir al menos un adulto en la casa.',
    faltaVivienda: 'Falta elegir cómo es tu casa.',
    faltaMotivo: 'Falta contar por qué este animal.',
    faltaConsentimiento: 'Falta marcar que aceptas lo de arriba.',
    enviadaTitulo: 'Enviada',
    // La promesa se escribe porque el reloj EXISTE (job de D, aplicado).
    enviadaPromesa: 'Si el refugio no responde en 5 días, te avisamos.',
    verConversacion: 'Ver la conversación',
    errorTitulo: 'No pudimos abrir el formulario',
    errorDetalle: 'Revisa tu conexión y prueba de nuevo.',
    reintentar: 'Probar de nuevo',
  },
  fichaAdoptable: {
  ...
  adoptar: {
    ...
    postular: 'Quiero conocer a {{nombre}}',
    postularSinCuenta: 'Quiero conocerlo · crear cuenta',
  ...
  placa: {
    titulo: 'Una placa de e-PetPlace',
    mirando: 'Mirando la placa…',
    ajena: 'Esta no es una placa de e-PetPlace.',
    yaEstaba: 'Esta placa ya está activada.',
    esperaAMascota: 'Esta placa espera a su mascota.',
    sinMascotas: 'Todavía no tienes ninguna mascota registrada.',
    noPudimosLeer: 'No pudimos leer tus mascotas. Prueba de nuevo.',
    quieroUna: 'Quiero una placa',
  ...
  busqueda: {
    ...
    grupo_pedidos: 'Pedidos',
    grupo_despensa: 'Despensa',
    grupo_prestadores: 'Prestadores',
    placeholder: 'Busca lo que sea de tu familia',
    ejemplo: 'Thor, vacuna, alimento…',
    entrada: 'Buscar en tu familia',
    sinResultados: 'No encontramos nada con «{{q}}».',
    preguntarANexo: 'Preguntarle a Nexo',
  },
  traerPapeles: {
  ...
  duranteGuarderia: {
    ...
    noRecogida: 'No pudieron recoger a {{nombre}}. El día se cobró y no se repone.',
  ...
  logGuarderia: {
    ...
    noRecogidaChip: 'No se pudo recoger',
    noRecogidaDetalle: 'No se pudo recoger a {{nombre}}. El día se cobró y no se repone.',
  ...
  despedida: {
    ...
    boton: 'Despedirme',
    confirmarSinNombre: 'Toca otra vez para despedirte',
  ...
  contanos: {
    ...
    guardar: 'Anotar',
    faltaTexto: 'Escribe algo para poder anotarlo',
    /* 🔴 Dice DÓNDE quedó, que es la pregunta que se hace quien acaba de
       escribir. «Guardado» a secas no la contesta. */
    anotado: 'Anotado en la vida de {{nombre}}',
    noSePudo: 'No pudimos anotarlo. Prueba de nuevo en un rato.',
  },
  ...
  postventa: {
    ...
    abrirHilo: 'Abrir la conversación',
