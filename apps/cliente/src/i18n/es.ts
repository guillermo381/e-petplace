...
export const clienteEs = {
  ...
  paquete: {
    ...
    chipDetalle: 'Salidas por adelantado con tu paseador — las reservas cuando quieras.',
    hojaTitulo: 'Tu paquete de salidas',
    hojaVoz: 'Salidas de {{min}} minutos con {{nombre}}. Compras hoy y reservas cada salida cuando la necesites.',
    ...
    noOfrece: '{{nombre}} no ofrece paquetes para esta duración.',
