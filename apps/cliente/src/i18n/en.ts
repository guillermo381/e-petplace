...
export const clienteEn = {
  ...
  recurrentes: {
    ...
    confirmarSinVuelta: 'Its period already ended. The plan isn’t lost: you can sign up again whenever you want, and from that day the charge moves to that day of the month.',
