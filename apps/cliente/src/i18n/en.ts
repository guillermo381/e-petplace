...
export const clienteEn = {
  ...
  seguridad: {
    ...
    soloGoogle:
      "You sign in to e-PetPlace with Google, so you don't have a password of your own yet. Write to us and we'll help you create one.",
    irASoporte: 'Message the team',
    mensajeSoporte: 'Hi, I sign in to e-PetPlace with Google and I want to create a password for my account.',
    soporteFallback: 'Message us on WhatsApp at {{numero}}.',
  },
  despensa: {
    titulo: 'Pantry',
