...
export const clienteEn = {
  ...
  paquete: {
    chip: 'Buy a package',
    chipDetalle: 'Walks paid upfront with your walker — book them whenever you want.',
    hojaTitulo: 'Your walk package',
    hojaVoz: '{{min}}-minute walks with {{nombre}}. Pay today and book each walk when you need it.',
    ...
    noOfrece: '{{nombre}} does not offer packages for this duration.',
