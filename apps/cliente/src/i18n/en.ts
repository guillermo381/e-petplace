...
export const clienteEn = {
  ...
  documentosGuarderia: {
    ...
    version: 'Version {{n}}',
    aceptacionTitulo: 'What you need to accept',
    leiYAcepto: 'I have read and accept:',
    opcional: 'Optional',
    faltaAceptar: 'Check all six documents to continue.',
    urgenciaTitulo: 'If there’s an emergency',
    urgenciaDetalle: 'How much you authorise them to spend without reaching you first.',
    topeEtiqueta: 'Limit in dollars',
    contactoTitulo: 'Who we call',
    contactoDetalle: 'If we can’t reach you.',
    contactoNombre: 'Name',
    ...
    faltaTope: 'Set a limit for emergencies.',
    faltaContacto: 'Your contact’s name and phone are missing.',
