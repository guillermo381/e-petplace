...
export const clienteEn = {
  ...
  lugarGuarderia: {
    ...
    mensualNoCobrable: 'We can’t charge the monthly plan yet. We’re finishing that part.',
    ...
    contratarMensualDesde: 'Start monthly plan on {{dia}}',
    faltaTarjeta: 'Pick the card we charge each month.',
    mensualMandato: 'You’re authorising the monthly charge. Nothing is charged today: the first charge goes out when the plan starts.',
  ...
  elegirGuarderia: {
    ...
    mensualLetra: 'The plan runs Monday to Friday. It’s charged on that same day every month until you cancel.',
