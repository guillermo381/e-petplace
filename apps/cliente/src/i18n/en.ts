...
export const clienteEn = {
  ...
  pago: {
    ...
    deunaCausaDesgloseIncompleto: "We're missing total details to charge you. Go back and try again.",
    ...
    deunaAmbiguoCuerpo: "We couldn't find this order. Go back and try again.",
