...
export const clienteEn = {
  ...
  lugarGuarderia: {
    ...
    mensualMandato: 'You’re authorising the monthly charge. We charge you today and then on the same day each month, until you cancel.',
  ...
  elegirGuarderia: {
    ...
    mensualLetra: 'The plan runs Monday to Friday. It starts today: you’re charged when you sign up, then on the same day each month, until you cancel.',
  ...
  checkoutGuarderia: {
    ...
    mensualExitoDetalleSinFecha: 'Your plan is active from today. The next charge goes out in a month, on the same day. You can cancel it from Account whenever you want.',
    continuar: 'Continue',
    ...
    mensualCuandoRepite: 'After that, the same day each month.',
