...
export const clienteEn = {
  ...
  checkoutGuarderia: {
    ...
    mensualExitoDetalle: 'Your plan is active from today and covered until {{fecha}}. It renews on its own, and you can cancel it from Account whenever you want.',
  ...
  recurrentes: {
    ...
    proximoCobro: 'Covered until {{fecha}} · renews on its own',
    ...
    confirmarReversible: 'You can turn it back on whenever you want.',
    confirmarSinVuelta: 'To get it back you’ll have to sign up again.',
