  ...
  return (
    <ThemeProvider>
      <CuerpoCaida
        ...
        voces={{
          verDetalle: clienteEs.caida.verDetalle,
          ocultarDetalle: clienteEs.caida.ocultarDetalle,
          copiar: clienteEs.caida.copiar,
          copiado: clienteEs.caida.copiado,
          sinCopiar: clienteEs.caida.sinCopiar,
        }}
      />
    </ThemeProvider>
  );
