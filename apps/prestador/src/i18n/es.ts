...
export const prestadorEs = {
  ...
  perfilNegocio: {
    ...
    iaIntroEscribir: 'Cuéntame dos cosas y armo un primer borrador con lo que ya sé de tu negocio. Vos decidís si lo usás.',
    iaIntroMejorar: 'Cuéntame dos cosas y mejoro lo que ya escribiste. No se cambia nada hasta que vos digas.',
  ...
  consulta: {
    ...
    /* El mismo registro del Durante: la plataforma JAMÁS sugiere medicamentos,
       tratamientos ni posologías. El placeholder nombra CAMPOS, no contenido. */
    vcNotaPlaceholder: 'Motivo, hallazgos, diagnóstico, plan…',
    vcHistoriaTitulo: 'Historia clínica',
  ...
  ventas: {
    ...
    config: {
      ...
      repartidorWhatsappAyuda: 'Es por donde le vas a escribir. Usa el mismo país del teléfono.',
      repartidorTipoDoc: 'Tipo de documento',
      tipoDoc: { cedula: 'Cédula', pasaporte: 'Pasaporte', ruc: 'RUC' },
      repartidorFotoDoc: 'Foto del documento',
      repartidorFotoPersona: 'Foto de la persona',
      repartidorFotoFallo: 'No se pudo usar esa foto. Probá de nuevo o elegí otra.',
      repartidorVehiculos: 'Con qué reparte — hasta dos',
      repartidorVehiculoTipo: 'Tipo',
      vehiculo: { moto: 'Moto', carro: 'Carro' },
      repartidorPlaca: 'Placa',
      repartidorAgregarVehiculo: 'Agregar vehículo',
      repartidorVehiculoFallo: 'El repartidor quedó registrado, pero la placa {{placa}} no se pudo guardar.',
      fotoTomar: 'Tomar foto',
      fotoCambiar: 'Cambiar foto',
      fotoGaleria: 'Elegir de galería',
      repartidorDocNoCoincide: 'Ese número no tiene la forma del tipo que elegiste. Revisá el número o cambiá el tipo.',
      repartidorWhatsappInvalido: 'Ese WhatsApp no es válido para el país elegido.',
      repartidorTelefonoInvalido: 'Ese teléfono no es válido para el país elegido.',
      repartidorVehiculoTope: 'Ya tiene dos vehículos. Para cambiar uno, quitá el que no use.',
      repartidorFaltaFoto: 'Falta la foto de la persona: es obligatoria para registrarla.',
      repartidorFaltaWhatsapp: 'Falta el WhatsApp: es por donde vas a poder contactarla.',
      repartidorFaltanDos: 'Faltan la foto de la persona y su WhatsApp — los dos son obligatorios.',
  ...
  diaGuarderia: {
    pReservadas_one: '{{count}} por buscar',
    pReservadas_other: '{{count}} por buscar',
    pReservadas: '{{count}} por buscar',
    pABordo_one: '{{count}} a bordo',
    pABordo_other: '{{count}} a bordo',
    pABordo: '{{count}} a bordo',
    pAdentro_one: '{{count}} adentro',
    pAdentro_other: '{{count}} adentro',
    pAdentro: '{{count}} adentro',
    pVolviendo_one: '{{count}} de vuelta',
    pVolviendo_other: '{{count}} de vuelta',
    pVolviendo: '{{count}} de vuelta',
    pEntregadas_one: '{{count}} entregado',
    pEntregadas_other: '{{count}} entregados',
    pEntregadas: '{{count}} entregados',
    pNoRecogidas_one: '{{count}} sin recoger',
    pNoRecogidas_other: '{{count}} sin recoger',
    pNoRecogidas: '{{count}} sin recoger',
    titulo: 'Tu día',
  ...
  actaGuarderia: {
    tituloRecogida: 'Recoger a {{nombre}}',
    tituloDevolucion: 'Entregar a {{nombre}}',
    rotuloItems: 'Antes de nada',
    itemCarnet: 'Vi el carnet',
    rotuloMedia: 'Cómo está',
    encuadre_animal_en_cuadro: 'Que se vea el animal.',
    encuadre_personas_no: 'Sin personas en la foto.',
    encuadre_menores_descarte: 'Si sale un menor, descarta la foto y saca otra.',
    encuadre_domicilio_primer_plano: 'Primer plano: que no salga la fachada ni el número de la casa.',
    rotuloObservaciones: 'Observaciones (opcional)',
    etiquetaObservaciones: 'Algo para dejar anotado (opcional)',
    objetosRecogida: '¿Viaja algo con él?',
    objetosDevolucion: '¿Le devuelves algo?',
    conformidadPendiente: 'La familia la confirma desde su app.',
    viajaAlgo: 'Sí, viaja algo',
    viajaNada: 'No, nada',
    objetosDetalle: 'Qué viaja con él',
    faltaObjetos: 'Contesta si viaja algo con él.',
    faltaObjetosDetalle: 'Escribe qué viaja con él.',
    faltanFotos: 'Saca al menos una foto de cómo está.',
    guardarActa: 'Guardar el acta',
  ...
  mediaGuarderia: {
    ...
    encuadre_menores_descarte: 'Si sale un menor, descarta la foto y saca otra.',
    encuadre_domicilio_primer_plano: 'Primer plano: que no salga la fachada ni el número de la casa.',
    quienesSalen: '¿Quiénes salen en la foto?',
    grabarClip: 'Grabar un clip',
    guiaClip: 'Un clip corto, de hasta 30 segundos.',
    grabar: 'Grabar',
    detener: 'Detener',
    ...
    sinPermiso: 'Necesitamos permiso para usar la cámara.',
    noSeGuardo: 'No se pudo guardar la foto. Prueba de nuevo.',
  },
  chipsGuarderia: {
    titulo: '¿Cómo se portó {{nombre}}?',
    comoSePorto: 'Marca lo que viste',
    algoMas: 'Algo más para contar (opcional)',
    registrar: 'Guardar',
    faltaAlgo: 'Marca al menos una cosa o escribe algo.',
    cargando: 'Buscando las opciones…',
    sinChips: 'No hay opciones para marcar. Puedes contarlo con tus palabras.',
  ...
  editarAdoptable: {
    ...
    microchip: 'Microchip',
    remetfu: 'REMETFU',
    puedePublicar: 'Se puede publicar.',
    conPerros: 'Con perros',
    conGatos: 'Con gatos',
    conNinos: 'Con niños',
    convSi: 'Sí',
    convNo: 'No',
    convNoSeSabe: 'Todavía no se sabe',
    historia: 'Su historia',
    senas: 'Señas particulares',
    zona: 'Zona o barrio',
    origen: '¿Cómo llegó?',
    origen_rescate: 'Rescate',
    origen_cesion: 'Cesión',
    vacunal: 'Vacunas',
    vacunal_al_dia: 'Al día',
    vacunal_incompleto: 'Incompletas',
    vacunal_sin_datos: 'Sin datos',
    urgente: 'Necesita hogar con urgencia',
    bonoMonto: 'Bono de adopción',
    bonoDestino: '¿A qué se destina?',
    fotos: 'Tiene {{n}} foto(s). Subirlas llega en la próxima tanda.',
    guardar: 'Guardar',
    guardado: 'Guardado.',
    sinCambios: 'No cambiaste nada todavía.',
    errorTitulo: 'No pudimos abrir su ficha',
    errorDetalle: 'Revisa tu conexión y prueba de nuevo.',
    reintentar: 'Probar de nuevo',
  },
  // S112-C · EL ACTA Y LA FIRMA — lado REFUGIO (§4.2).
  actaRefugio: {
    titulo: 'El acta de adopción',
    estadoFirmas: 'Firmaste · falta la firma de la familia ({{n}} de 2)',
    falta_cedula: 'Tu cédula',
    falta_domicilio: 'Tu domicilio',
    faltaOtro: 'Falta un dato del acta: {{que}}. Cárgalo en la ficha del animal.',
    ...
    completaTitulo: 'La adopción quedó firmada',
    completaCuerpo: 'El animal pasó a su familia con todo su historial.',
    folio: 'Folio {{folio}}',
    volverAlPortal: 'Volver a las solicitudes',
  ...
  portalHilo: {
    ...
    titulo: 'La solicitud',
    alguienSinNombre: 'Alguien de la comunidad',
    sinMensajes: 'Todavía no hay mensajes.',
    escribirEtiqueta: 'Escribe a la familia',
    enviar: 'Enviar',
    razonSinTexto: 'Escribe un mensaje para poder enviarlo.',
    cerrado: 'Esta conversación ya se cerró.',
    aceptar: 'Aceptar',
    declinar: 'Declinar',
    cancelar: 'Cancelar',
    aceptarTitulo: '¿Aceptas esta solicitud?',
    aceptarCuerpo: 'La familia va a poder seguir con la adopción. La conversación se cierra y no se puede volver atrás.',
    aceptarConfirmar: 'Sí, aceptar',
    aceptadaOk: 'Aceptaste la solicitud.',
    declinarTitulo: '¿Declinas esta solicitud?',
    declinarCuerpo: 'La familia va a ver que no siguió. La conversación se cierra y no se puede volver atrás.',
    declinarConfirmar: 'Sí, declinar',
    declinadaOk: 'La solicitud quedó cerrada.',
