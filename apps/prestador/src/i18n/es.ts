...
export const prestadorEs = {
  ...
  equipo: {
    ...
    errorInvitar: 'No pudimos enviar la invitación. Revisa el correo e intenta de nuevo.',
    rolDueno: 'Dueño',
    ...
    invitarEmail: 'Correo',
    invitarAyuda: 'La persona entra sin permisos. Cuando acepte, le asignas su rol acá.',
    invitarEnviar: 'Enviar invitación',
