...
export const prestadorEs = {
  ...
  diaGuarderia: {
    ...
    marcarPendienteApoyo: 'Lo que sí puedes dejar es el acta de cada uno, con sus fotos y su hora.',
  },
  actaGuarderia: {
    ...
    etiquetaObservaciones: 'Algo para dejar anotado',
    objetosRecogida: 'Qué viaja con él',
    objetosDevolucion: 'Qué le devuelves',
