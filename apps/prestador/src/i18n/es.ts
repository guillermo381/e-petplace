...
export const prestadorEs = {
  ...
  tallerGuarderia: {
    ...
    ofrecePaquete: 'Ofrezco paquete de días',
    precioPaquete: 'Precio del paquete',
    ofreceMensual: 'Ofrezco mensualidad',
    precioMensual: 'Precio del mes',
    precioPlaceholder: '0.00',
    paqueteInvalido: 'El precio del paquete tiene que ser mayor a cero. Déjalo vacío si no ofreces paquete.',
    mensualInvalido: 'El precio mensual tiene que ser mayor a cero. Déjalo vacío si no ofreces mensualidad.',
