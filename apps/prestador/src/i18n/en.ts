...
export const prestadorEn = {
  ...
  equipo: {
    ...
    errorInvitar: 'We could not send the invitation. Check the email and try again.',
    rolDueno: 'Owner',
    ...
    invitarNombre: 'Name',
    invitarEmail: 'Email',
    invitarAyuda: 'They join without permissions. Once they accept, you assign their role here.',
    invitarEnviar: 'Send invitation',
