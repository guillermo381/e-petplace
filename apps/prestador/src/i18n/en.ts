...
export const prestadorEn = {
  ...
  agenda: {
    ...
    presenciaEnViaje_other: '{{count}} on the way',
    presenciaReservados_one: '{{count}} booked',
    presenciaReservados_other: '{{count}} booked',
    presenciaAdentro: '{{count}} inside',
    presenciaEnViaje: '{{count}} on the way',
    presenciaReservados: '{{count}} booked',
    estadiaAdentroDesde: 'Inside since {{hora}}',
    estadiaAdentro: 'Inside',
    estadiaEnCaminoDesde: 'On the way since {{hora}}',
    estadiaEnCamino: 'On the way',
    estadiaDeVueltaDesde: 'Heading back since {{hora}}',
    estadiaDeVuelta: 'Heading back',
    estadiaEntregadaA: 'Handed over at {{hora}}',
    estadiaEntregada: 'Handed over',
    estadiaNoRecogida: 'Not picked up',
    estadiaCancelada: 'Cancelled',
    estadiaReservada: 'Booked',
  ...
  consulta: {
    ...
    vcVozColgar: 'End the consultation',
    ...
    vcAsaModal: 'Notes and record',
    vcNotaTitulo: 'Consultation note',
    vcNotaPlaceholder: 'Reason, findings, diagnosis, plan…',
    vcHistoriaTitulo: 'Clinical record',
    vcHistoriaLectura: 'Read-only during the consultation.',
    vcFiltroFecha: 'By date',
    vcFiltroCaso: 'By case type',
    vcHistoriaFiltroCaso: 'Filter by case',
    vcHistoriaTodo: 'All',
    vcHistoriaCargando: 'Looking up their history…',
    ...
    vcColgarDetalle: 'It also closes for the family, and no one can rejoin. Your note is kept.',
  ...
  tallerGuarderia: {
    especiesTitulo: 'Species you take',
    especiePerro: 'Dogs',
    especieGato: 'Cats',
    especiesMinima: 'Pick at least one: with no species, your daycare can’t take anyone.',
    titulo: 'Daycare',
    ...
    precioTitulo: 'Your price',
    preciosTitulo: 'Your prices',
    diario: 'Daily',
    mensual: 'Monthly plan',
    porMes: 'per month',
    franjasResumen: 'Pick-up {{recogeDesde}}–{{recogeHasta}} · Drop-off {{devuelveDesde}}–{{devuelveHasta}}',
    espejoTitulo: 'How the owner sees it',
    espejoApoyo: 'The same thing a family sees when they open your daycare.',
    espejoVacio: 'With no price turned on, a family sees nothing here.',
    avisoSinPrecioTitulo: 'You’re saving without prices',
    avisoSinPrecio: 'Everything you set up is saved, but without prices your services aren’t published. You don’t lose anything you entered.',
    avisoVolver: 'Go back and set a price',
    avisoGuardarAsi: 'Save like this',
    avisoSinDiarioTitulo: 'You’re saving without a daily price',
    avisoSinDiario: 'You’ll publish with {{modalidades}} only. Anyone who finds you won’t be able to book a single day.',
    avisoEntendido: 'Got it, save',
    precioDia: 'Your price per day',
    ofrecePaquete: 'Stay package',
    paquetesTitulo: 'Stay packages',
    paquetesApoyo: 'Turn on the ones you want to offer. Each one carries its own price.',
    estadias: '{{n}} stays',
    precioDelPaquete: 'Price for {{n}} stays',
    equivalenteSimple: 'Works out to ${{porDia}} per day',
    equivalenteIgual: 'Works out to ${{porDia}} per day — same as single days',
    equivalenteMenos: 'Works out to ${{porDia}} per day — {{pct}}% less than single days',
    equivalenteMas: 'Works out to ${{porDia}} per day — {{pct}}% more than single days',
    ofreceMensual: 'Monthly plan',
    precioMensual: 'Monthly price',
    visibleSi: 'Your daycare is visible for bookings.',
    visibleNo: 'Your daycare isn’t visible for bookings yet.',
    visibleNoApoyo: 'Save your capacity, your two windows and your daily price. That’s what puts it on the shelf.',
    jornadaDerivada: 'The day length comes from your windows: {{horas}} hours, from when you start picking up to when you finish dropping off.',
  },
  mundoGuarderia: {
    titulo: 'Daycare',
    tuDia: 'Your day',
    tuDiaDetalle: 'The animals you take in today',
    configuracion: 'Settings',
    configuracionDetalle: 'Capacity, windows and price',
    sinConfigurarTitulo: 'You haven’t set up your daycare yet',
    sinConfigurarDetalle: 'Set how many animals you take per day, your two windows and your price. That puts you on the shelf.',
    configurar: 'Set up',
    editar: 'Edit your daycare',
    visibleTitulo: 'Visible for bookings',
    noVisibleTitulo: 'Not visible yet',
    faltaPublicar: 'You still need to save your daily price to go on the shelf.',
    resumenPrecio: '${{precio}} per day',
    resumenJornada: '{{horas}}-hour day',
    resumenCupo: '{{n}} animals per day',
  },
  diaGuarderia: {
    pReservadas_one: '{{count}} to pick up',
    pReservadas_other: '{{count}} to pick up',
    pReservadas: '{{count}} to pick up',
    pABordo_one: '{{count}} on board',
    pABordo_other: '{{count}} on board',
    pABordo: '{{count}} on board',
    pAdentro_one: '{{count}} inside',
    pAdentro_other: '{{count}} inside',
    pAdentro: '{{count}} inside',
    pVolviendo_one: '{{count}} heading back',
    pVolviendo_other: '{{count}} heading back',
    pVolviendo: '{{count}} heading back',
    pEntregadas_one: '{{count}} handed over',
    pEntregadas_other: '{{count}} handed over',
    pEntregadas: '{{count}} handed over',
    pNoRecogidas_one: '{{count}} not picked up',
    pNoRecogidas_other: '{{count}} not picked up',
    pNoRecogidas: '{{count}} not picked up',
    titulo: 'Your day',
    cuantos: '{{n}} animals today',
    estado_reservada: 'To pick up',
    estado_recogida_en_curso: 'On the way',
    estado_en_guarderia: 'Here',
    estado_retorno_en_curso: 'Heading home',
    estado_entregada: 'Delivered',
    estado_cancelada: 'Cancelled',
    estado_no_recogida: 'Couldn’t pick up',
    ...
    fotoRazonLlegadaDe: "It unlocks when you check {{nombre}} in",
    fotoRazonPrimeraLlegada: 'It unlocks when you check the first one in',
    subir: 'Up',
    bajar: 'Down',
  ...
  actaGuarderia: {
    tituloRecogida: 'Pick up {{nombre}}',
    tituloDevolucion: 'Drop off {{nombre}}',
    rotuloItems: 'First things first',
    itemCarnet: 'I saw the vaccination record',
    rotuloMedia: 'How they look',
    encuadre_animal_en_cuadro: 'Make sure the animal is in frame.',
    encuadre_personas_no: 'No people in the photo.',
    encuadre_menores_descarte: 'If a child appears, discard the photo and take another.',
    encuadre_domicilio_primer_plano: 'Close up: keep the house front and street number out.',
    rotuloObservaciones: 'Notes (optional)',
    etiquetaObservaciones: 'Anything worth writing down (optional)',
    objetosRecogida: 'Is anything traveling with them?',
    objetosDevolucion: 'Are you handing anything back?',
    conformidadPendiente: 'The family confirms it from their app.',
    viajaAlgo: 'Yes, something',
    viajaNada: 'No, nothing',
    objetosDetalle: 'What travels with them',
    faltaObjetos: 'Answer whether anything travels with them.',
    faltaObjetosDetalle: 'Write what travels with them.',
    faltanFotos: 'Take at least one photo of how they look.',
    guardarActa: 'Save the record',
  ...
  mediaGuarderia: {
    ...
    encuadre_menores_descarte: 'If a child appears, discard the photo and take another.',
    encuadre_domicilio_primer_plano: 'Close up: keep the house front and street number out.',
    quienesSalen: 'Who is in the photo?',
    grabarClip: 'Record a clip',
    guiaClip: 'A short clip, up to 30 seconds.',
    grabar: 'Record',
    detener: 'Stop',
    ...
    sinPermiso: 'We need permission to use the camera.',
    noSeGuardo: 'The photo could not be saved. Try again.',
  },
  chipsGuarderia: {
    titulo: 'How did {{nombre}} do?',
    comoSePorto: 'Mark what you saw',
    algoMas: 'Anything else to share (optional)',
    registrar: 'Save',
    faltaAlgo: 'Mark at least one thing or write something.',
    cargando: 'Loading the options…',
    sinChips: 'No options to mark. You can tell it in your own words.',
  ...
  editarAdoptable: {
    ...
    huerfano: 'We removed the photo from the profile, but the file stayed. Let us know.',
    sinFotos: 'No photos yet. The first one you add becomes the cover.',
    esPortada: 'Cover',
    foto: 'Photo {{n}}',
    subirUna: 'Move up',
    borrarFoto: 'Remove',
    agregarFoto: 'Add a photo',
    titulo: 'Their profile',
    especie: 'Species',
    sexo: 'Sex',
    talla: 'Size',
    microchip: 'Microchip',
    remetfu: 'REMETFU',
    puedePublicar: 'Ready to list.',
    conPerros: 'With dogs',
    conGatos: 'With cats',
    conNinos: 'With children',
    convSi: 'Yes',
    convNo: 'No',
    convNoSeSabe: "We don't know yet",
    historia: 'Their story',
    senas: 'Distinctive marks',
    zona: 'Area or neighbourhood',
    origen: 'How did they arrive?',
    origen_rescate: 'Rescue',
    origen_cesion: 'Surrender',
    vacunal: 'Vaccines',
    vacunal_al_dia: 'Up to date',
    vacunal_incompleto: 'Incomplete',
    vacunal_sin_datos: 'No records',
    urgente: 'Urgently needs a home',
    bonoMonto: 'Adoption fee',
    bonoDestino: 'What is it for?',
    fotos: 'They have {{n}} photo(s). Uploading arrives in the next batch.',
    guardar: 'Save',
    guardado: 'Saved.',
    sinCambios: "You haven't changed anything yet.",
    errorTitulo: "We couldn't open their profile",
    errorDetalle: 'Check your connection and try again.',
    reintentar: 'Try again',
  },
  actaRefugio: {
    titulo: 'The adoption agreement',
    estadoFirmas: "You signed · the family's signature is missing ({{n}} of 2)",
    falta_cedula: 'Your ID number',
    falta_domicilio: 'Your address',
    faltaOtro: "The agreement is missing: {{que}}. Add it in the animal's profile.",
    faltaCargar: 'Fill in what is missing above to sign.',
    faltaLeer: 'Read the agreement to the end to sign.',
    pedirCodigo: 'Sign',
    codigoEtiqueta: 'Your signing code',
    codigoAyuda: 'We sent it to {{a}}. It expires in 10 minutes.',
    codigoEnviado: 'We sent the code to {{a}}.',
    faltaCodigo: 'Enter the 8 digits we sent you.',
    firmar: 'Sign the agreement',
    completaTitulo: 'The adoption is signed',
    completaCuerpo: 'The animal moved to their family with their whole history.',
    folio: 'Folio {{folio}}',
    volverAlPortal: 'Back to applications',
    errorTitulo: "We couldn't open the agreement",
    errorDetalle: 'Check your connection and try again.',
    reintentar: 'Try again',
  },
  adoptables: {
  ...
  portalAdopcion: {
    ...
    errorTitulo: "We couldn't load the requests",
    errorDetalle: 'Check your connection and try again.',
  },
  miVitrina: {
    permisoFotos: 'We need permission to see your photos.',
    ...
    sinPaginaDetalle: 'Tell people who you are and where you rescue from. It’s what a family sees before writing to you.',
    armarla: 'Build my page',
    vozSinPagina: 'Your page is still blank',
    descripcionSinPagina: 'Your published animals still show.',
    editar: 'Edit my page',
    editarTitulo: 'Your page',
    campoHistoria: 'Your story',
    campoCiudad: 'City',
    campoZona: 'Area',
    guardar: 'Save',
    guardado: 'Saved.',
    tusAnimales: 'Your published animals',
    sinPublicadosTitulo: "You haven't published any yet",
    sinPublicadosDetalle: "The ones still in rescue don't show here until you publish them.",
    edadNoInformada: 'Age not given',
    sinFotosAun: "The cover photo and logo can't be edited from here yet.",
    comoAyudar: 'How to help',
    comoAyudarEtiqueta: 'What “How to help” is',
    especiePerro: 'Dog',
    especieGato: 'Cat',
    comoAyudarPronto: "It's not ready yet. When it is, you'll be able to receive donations and sponsorships from your page.",
    noSosRefugio: "Your account isn't verified as a shelter yet. Write to us so we can review it.",
    yaTenesPrestadorConOficio: 'Your account is already registered as {{oficio}}. Today one account cannot be both.',
    yaTenesPrestador: 'Your account is already registered with another trade. Today one account cannot be both.',
    errorTitulo: "We couldn't open your page",
    errorDetalle: 'Try again in a moment.',
    reintentar: 'Try again',
  },
  portalHilo: {
    verPostulacion: 'See application',
    postulacionTitulo: 'Their application',
    postulacionSinDatos: 'This request has no form.',
    postHogar: 'Who lives at home',
    postAdultos_one: '{{count}} adult',
    postAdultos_other: '{{count}} adults',
    postAdultos: '{{count}} adults',
    postMenores05_one: '{{count}} aged 0 to 5',
    postMenores05_other: '{{count}} aged 0 to 5',
    postMenores05: '{{count}} aged 0 to 5',
    postMenores612_one: '{{count}} aged 6 to 12',
    postMenores612_other: '{{count}} aged 6 to 12',
    postMenores612: '{{count}} aged 6 to 12',
    postMenores1317_one: '{{count}} aged 13 to 17',
    postMenores1317_other: '{{count}} aged 13 to 17',
    postMenores1317: '{{count}} aged 13 to 17',
    postVivienda: 'Where they live',
    vivienda_casa_con_patio: 'House with a yard',
    vivienda_casa_sin_patio: 'House without a yard',
    vivienda_departamento: 'Apartment',
    vivienda_otro: 'Other',
    postHorasSolo: 'Hours alone',
    postHoras_one: '{{count}} hour a day',
    postHoras_other: '{{count}} hours a day',
    postHoras: '{{count}} hours a day',
    postOtrosAnimales: 'Other animals at home',
    postExperiencia: 'Their experience',
    postMotivo: 'Why they want to adopt',
    etapaEnviada: 'Sent',
    etapaEnConversacion: 'In conversation',
    etapaAceptada: 'Accepted',
    etapaActaFirmada: 'Agreement signed',
    etapaUnaVidaNueva: 'A new life',
    laSolicitudEstaEn: 'The request is at: {{etapa}}',
    escaleraAlternar: 'See the request steps',
    hoy: 'Today',
    ayer: 'Yesterday',
    noSeEnvio: "Didn't send · Retry",
    escribirlePlaceholder: 'Write to {{quien}}',
    ...
    escribirEtiqueta: 'Write to the family',
    enviar: 'Send',
    razonSinTexto: 'Write a message to send it.',
    cerrado: 'This conversation is closed.',
    aceptar: 'Accept',
    declinar: 'Decline',
    cancelar: 'Cancel',
    aceptarTitulo: 'Accept this request?',
    aceptarCuerpo: 'The family will be able to go ahead with the adoption. The conversation closes and cannot be undone.',
    aceptarConfirmar: 'Yes, accept',
    aceptadaOk: 'You accepted the request.',
    declinarTitulo: 'Decline this request?',
    declinarCuerpo: "The family will see it didn't go ahead. The conversation closes and cannot be undone.",
    declinarConfirmar: 'Yes, decline',
    declinadaOk: 'The request is now closed.',
  ...
  postventa: {
    casosTitulo: 'Cases',
    casosIntro: 'There are families waiting for your reply.',
    casosVacio: 'You have no open cases.',
    casosNoSePudo: "We couldn't load your cases. Try again.",
    objeto_cita: 'An appointment',
    objeto_estadia: 'A stay',
    objeto_pedido: 'An order',
    laFamilia: 'The family',
    teQuedan: 'You have {{horas}} hours to reply',
    puntero: 'Cases',
    ...
    asientoYo: 'You',
    escribirPlaceholder: 'Write your reply',
    conversacionCerrada: 'This conversation is now read-only',
    noSeEnvio: "Didn't send · Retry",
    enviarMensaje: 'Send',
    laCasaTomoElCaso: 'e-PetPlace took the case',
    reconocerYResolver: 'Acknowledge and resolve',
    pedirALaCasa: 'Ask e-PetPlace to step in',
    reconocerTitulo: 'How do you resolve it?',
