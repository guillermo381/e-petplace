...
export const prestadorEn = {
  ...
  diaGuarderia: {
    ...
    marcarPendienteApoyo: 'What you can leave is each animal’s record, with its photos and its time.',
  },
  actaGuarderia: {
    ...
    rotuloObservaciones: 'Notes',
    etiquetaObservaciones: 'Anything worth writing down',
    objetosRecogida: 'What travels with them',
    objetosDevolucion: 'What you are handing back',
