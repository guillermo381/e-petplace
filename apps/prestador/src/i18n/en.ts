...
export const prestadorEn = {
  ...
  negocio: {
    ...
    // S58-B B1b · Espejo de es.ts
    paseo: 'Walks',
    paseoDetalle: 'Your full offer: durations, prices and hours.',
  ...
  taller: {
    ...
    d240: '4 hours',
    d300: '5 hours',
    noOfrecida: "You don't offer this duration.",
    seOfreceAlGuardar: 'Offered once you save.',
    ofrecer: 'Offer this duration',
    pausarDuracion: 'Pause this duration',
    reactivarDuracion: 'Resume this duration',
    nombreDescripcion: 'Name and description',
    nombreDescripcionVacio: 'Optional — how your clients see it.',
    planPaqueteTitulo: 'Plan and package',
    planPaqueteExplica: 'Per-outing prices for your frequent clients.',
    planPaqueteSinDuraciones: 'Offer a duration first: the plan and the package are set on top of it.',
    planResumen: 'Plan {{precio}}',
    paqueteResumen: 'Package {{precio}}',
    sinPlanNiPaquete: 'No plan or package',
    horariosTitulo: 'Days and hours',
    sinFranjasDia: 'No windows this day.',
    ...
    sinZonas: "You haven't declared any city yet.",
    zonaNueva: 'Added once you save.',
    agregarCiudad: 'Add city',
    ciudadFaltante: "If your city isn't listed, write to us: the team maintains the catalog.",
    quitarCiudad: 'Remove {{ciudad}} from your coverage?',
    quitarCiudadConfirmar: 'Yes, remove',
    listo: 'Done',
  ...
  ofertaPaseo: {
    ...
    vacioCuerpo: 'In the workshop you choose durations, prices and hours. Your clients only see what you activate.',
    vacioCta: 'Open the workshop',
