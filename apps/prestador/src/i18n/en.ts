...
export const prestadorEn = {
  ...
  tallerGuarderia: {
    ...
    paqueteInvalido: 'The package price must be greater than zero. Leave it empty if you don’t offer one.',
    mensualInvalido: 'The monthly price must be greater than zero. Leave it empty if you don’t offer one.',
