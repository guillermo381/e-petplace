-- ════════════════════════════════════════════════════════════════════════════
-- S113-A · «proplan» no encontraba «Pro Plan» — 15 productos invisibles
--
-- El FTS compara palabra por palabra: `proplan` es un token distinto de
-- `pro`+`plan`. Entra un SEGUNDO pase que compara sin espacios, guiones ni
-- acentos — **aditivo**, después del normal y sin reemplazarlo.
-- ════════════════════════════════════════════════════════════════════════════
