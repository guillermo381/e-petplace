-- S114-A · ⑦ · _contexto_coach_base expone bienvenida_regreso para el Coach
-- El Coach lo consume una vez al mostrar «Qué bueno tenerlo de vuelta.»
-- 76(g): NO RIGE — agrega un campo al contexto, sin datos.
BEGIN;
...
begin
  ...
  v_base := jsonb_build_object(
    ...
    'estado_vida', case when v_memorial then 'memorial' else v_m.estado_vida end,
    'bienvenida_regreso', v_m.bienvenida_regreso_pendiente,   -- S114-A ⑦   -- perdida viaja como 'perdida', no como 'memorial'
    'sexo', v_m.sexo,
    'edad_texto', v_edad,
