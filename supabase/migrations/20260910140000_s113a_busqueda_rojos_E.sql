-- ════════════════════════════════════════════════════════════════════════════
-- S113-A · dos rojos de E (pista/s113-e-3.0), curados por la CAUSA
--
-- ① Los productos nunca aparecían. E lo atribuyó al literal («las 470 filas
--    dicen activo»), y eso es cierto pero no es la causa: la publicación de un
--    producto **no vive en `productos.estado`**, vive en
--    `ofertas.estado='publicada'`. Cambiar el literal habría curado el síntoma
--    y dejado la pregunta equivocada.
--
-- ② El techo cortaba antes de priorizar.
--
-- Se AMPLÍA sobre el cuerpo vivo sacado de `pg_get_functiondef`, no se
-- reescribe: los siete brazos siguen intactos.
-- ════════════════════════════════════════════════════════════════════════════
