-- ═══════════════════════════════════════════════════════════════════════════
-- S89-A · ORDEN 5 ② — LA GRACIA DE 7 DÍAS QUEDA FIRMADA (founder, 6-ago-2026)
--
-- Cambio de UN comentario en el body vivo: `v_gracia_dias := 7` deja de decir
-- «PROPUESTO A MESA» — la firma llegó y el objeto no puede seguir diciendo lo
-- contrario (la clase del guard cuyo mensaje miente, S84/S88). La letra vive
-- en MODELO_PASEO §6 punto 5 (enmendado con la firma) y la ficha D-669
-- retiró su ⚠️. Cero cambio de comportamiento.
-- 76(g) NO RIGE · D-662 cero contrato · L-140 proacl intacto.
-- REVERSA: docs/relevamientos/2026-08-06-s89a-REVERSA-gracia-firmada.sql
-- ═══════════════════════════════════════════════════════════════════════════
...
DECLARE
  ...
  v_gracia_dias int := 7;   -- FIRMADO founder 6-ago-2026 (letra: MODELO_PASEO §6 punto 5 · D-669)
BEGIN
  FOR v_susc IN
