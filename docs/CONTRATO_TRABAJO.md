...
> **Versión:** v1.18 (con enmiendas S14 + S15 + S16 + S19 + S21 + S42 + S48 + S54 + S59 + S68 + S71 + S79 + S80 + S81)
> **Última actualización:** 29 Jul 2026 — Sesión 81. Regla 80 (el craft se ve en la pantalla real) + enmienda a regla 79 (cada hash con su asunto) + **76(h): cada sesión declara SUS archivos al abrir tanda** (founder — un árbol compartido sin dueños declarados costó tres incidentes en un día).
