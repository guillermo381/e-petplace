...
| **13** | **El compromiso de esterilización — la única pieza de S112 que no estaba escrita en ningún lado hasta que B la nombró.** En la ficha, «Esterilizado» pasa a ser dato de semáforo; en un animal de **menos de seis meses sin esterilizar** dice *"se entrega con compromiso de esterilización"* en vez de un rojo. Del lado del portal, al publicar un animal de **más de seis meses sin esterilizar**, el interruptor **no enciende y dice por qué**: *"Los mayores de seis meses se publican esterilizados (Ordenanza 019)."* No es una variante de "falta el dato" — es un cuarto estado con voz propia. **`SemaforoSanitario` (B) espera esta firma para construirse; hoy no existe.** | `S112-B.md`, "QUÉ ME DEBEN" | Tu firma sobre la Ordenanza 019 y el compromiso de esterilización |
