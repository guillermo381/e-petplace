...
⚖️ **«Zona segura 66 %» tiene DOS lecturas y dan tamaños distintos — van las dos a la mesa, no elijo yo:**

| | lectura | ancho |
|:-:|---|--:|
| **A** | el LADO del dibujo mide 66 % del lienzo | **676 / 1024 = 66 %** |
| **B** | el dibujo CABE dentro del círculo del 66 % | **570 / 1024 = 56 %** |

El dibujo es **ancho** (820 × 522), así que su diagonal es 972: con la lectura A **se sale del círculo de recorte por los lados**. B es lo que «zona segura» significa en Android; A es lo que la orden dice literal. `icono-app.svg` está compuesto con **A**; cambiar a B es un número.
...
| `capturas-s116-b-2b/icono-app.png` | el ícono a 48 · 72 · 96 · 192 dp con el círculo de recorte dibujado |
| `capturas-s116-b-2b/icono-app-dos-lecturas.png` | **A y B lado a lado**, para la decisión de la mesa |
...
| | por qué |
|---|---|
| **Capturas de las cuatro pantallas con el token nuevo** | **cambió, y por eso hacen falta** — el cambio de Baloo toca toda pantalla del cliente. **No las tomé**: el emulador no se levantó en esta tanda. *Se declara en vez de entregar las del lote 2, que muestran el estado viejo.* |
| **El gate por ícono del founder** | la hoja está lista; firmarla no es mío |
| **La lectura A vs B de la zona segura** | medida y servida; la elige la mesa |
