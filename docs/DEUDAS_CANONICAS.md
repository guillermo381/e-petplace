...
**Nota S68 (origen: reporte S68-B): declarada INTACTA con su disparo — el camino de la tanda de horarios S68-B2 no la cruzó.** **Nota S68-A9: la conversión atómica (`convertir_horarios_a_por_servicio`, enmienda D-386) cura la pérdida de FRANJAS del cambio de modo; el resto (2) de esta deuda — los BORRADORES de precio sin guardar que la recarga del taller pierde — queda INTACTO con su disparo.**
