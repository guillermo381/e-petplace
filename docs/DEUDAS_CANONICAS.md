...
#### D-509 — EL LINK DE INVITACIÓN (decisión founder) 🟠
...
#### D-512 — 🔴 EL ARCO DE EQUIPO ESTÁ **CONSTRUIDO Y DESCONECTADO** (la app anclada al titular; recepción v1 sin gate posible)
...
#### D-514 — 🔴 EL HANDSHAKE DE ACEPTACIÓN NO EXISTE (lo más bloqueante del arco de equipo)
