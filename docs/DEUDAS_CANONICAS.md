...
**LAS CUATRO PREGUNTAS A LA MESA DEL ARCO v2 (literales, del §4 del censo):** **(1)** *¿D-513 sigue siendo bloqueante de la puerta?* — no, ya salió (arriba). **(2)** *¿Se amplía la gestión al administrador ahora o es construcción del arco?* — arco v2. **(3)** *El nudo de horarios/`empleado_id`: si un administrador que NO es titular edita "las franjas del negocio", ¿escribe las del titular, las suyas, o el negocio unipersonal tiene "franjas del negocio" vs "franjas de cada persona"?* — decisión de modelo, con B. **(4)** *`ph_empleado_own` (habilitador del modelo por-persona, hoy inerte): ¿se toca?* — propuesta: se deja, es infra futura correcta. **Disparo: la mesa del arco de equipo v2.** Origen: S74-A (cruce); re-encuadrada S75-A3.
