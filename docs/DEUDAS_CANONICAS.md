...
#### D-395 — El MOTION de marca de la bienvenida (video/animación)
🟢 MEDIA. La bienvenida v1 es ESTÁTICA digna (letra founder S61: la composición de la propuesta entra traducida a la casa; el movimiento queda como deuda). El momento de marca — huella/isotipo con motion de entrada, o video corto — se diseña con DIRECCION_ARTE §5 (motion de marca, jamás decorativo) y se gatea en dispositivo. **Disparo: la sesión de marca, o pre-soft-launch.** Origen: S61 (letra de la bienvenida).
