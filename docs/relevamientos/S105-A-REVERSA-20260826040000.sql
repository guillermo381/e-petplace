-- REVERSA de 20260826040000_s105a_comprobante_con_impuesto.sql
-- Escrita ANTES de aplicar.
-- QUÉ DESHACE: el comprobante vuelve a NO llevar impuesto desglosado.
-- 🔴 QUÉ NO DESHACE: los comprobantes YA emitidos con desglose lo conservan.
-- CONSECUENCIA: el día que se cobre un producto gravado, el correo va a decir
-- el total y **callar cuánto de eso es IVA** — sobre una venta donde el
-- impuesto existió de verdad. Medido antes de curar: 0 de 27 lo llevaban.
