-- ═══════════════════════════════════════════════════════════════════════════
-- REVERSA de 20260806250000_s89a_datos_para_plantillas.sql
-- Escrita ANTES. Bodies vivos pre-migración de los cuatro productores.
-- Revertir deja las plantillas por tipo sin sus datos (el correo cae al
-- cuerpo genérico) — cero rotura funcional.
-- ═══════════════════════════════════════════════════════════════════════════
