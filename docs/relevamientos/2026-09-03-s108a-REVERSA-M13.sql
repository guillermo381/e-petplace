-- REVERSA de 20260903220000_s108a_la_causa_se_publica.sql — escrita ANTES.
-- ⚠️ Revertir vuelve a DESCARTAR la causa del fallo del acto 2 en las dos ramas:
--    el evento vuelve a decir `acto2=false` sin decir por qué, y saber la causa
--    vuelve a exigir reproducir el cobro a mano.
BEGIN;
