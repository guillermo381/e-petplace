-- REVERSA de 20260901180000_s108a_actuador_dos_sujetos.sql — ANTES.
-- ⚠️ NO deshace: los bonos acreditados ni los períodos generados. Revertir
--    devuelve al actuador la IGNORANCIA de los dos sujetos: vuelve a marcarlos
--    `desconocido` con ok:false (honesto, sin mover). Y el trigger vuelve a
--    tirar a la basura el ok:false de mover_sujeto_por_reverso.
BEGIN;
