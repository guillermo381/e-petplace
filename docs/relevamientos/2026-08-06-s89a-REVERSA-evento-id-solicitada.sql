-- ═══════════════════════════════════════════════════════════════════════════
-- REVERSA de 20260806210000_s89a_adjudicacion_evento_id_solicitada.sql
-- Escrita ANTES. Bodies vivos pre-migración (post-tuteo NO — esta reversa es
-- de las DOS funciones productoras, que el tuteo no toca).
-- Revertir deja a cita_solicitada sin referente de evento (el fork de C
-- vuelve a caer al fallback de mascota).
-- ═══════════════════════════════════════════════════════════════════════════
