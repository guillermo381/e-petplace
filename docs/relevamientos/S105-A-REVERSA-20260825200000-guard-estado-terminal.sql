-- ===========================================================================
-- REVERSA de 20260825200000_s105a_guard_estado_terminal.sql
-- ===========================================================================
-- Escrita ANTES de aplicar, con la definicion VIVA.
--
-- QUE DESHACE: quita el guard de estado terminal de los DOS UPDATE del actuador.
--
-- ⚠️ QUE NO DESHACE, y decide si conviene correrla: revertir REABRE D-916 --
--   un evento de aprobacion posterior a un reverso vuelve a poder revivir el
--   intento. Hoy eso es INALCANZABLE porque nada produce 'reversado'; deja de
--   serlo en cuanto exista el productor (D-923). **Despues de D-923, revertir
--   esto es abrir una puerta con la cerradura ya construida.**
-- ===========================================================================
