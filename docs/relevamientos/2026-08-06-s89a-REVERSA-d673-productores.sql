-- ═══════════════════════════════════════════════════════════════════════════
-- REVERSA de 20260806160000_s89a_d673_productores_cita_en_sombra.sql
-- Escrita ANTES de aplicar. Restaura los TRES bodies vivos pre-migración
-- (capturados con pg_get_functiondef el 2026-08-06): _voz_notificacion sin
-- las tres voces de cita · confirmar_cita_pagada y reservar_salida_paquete
-- sin productores. Revertir DEJA DE PRODUCIR los avisos de cita (en sombra).
-- Nota de datos: las intenciones ya registradas no se borran.
-- ═══════════════════════════════════════════════════════════════════════════
