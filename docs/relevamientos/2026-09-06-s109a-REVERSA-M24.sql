-- REVERSA de 20260906140000_s109a_else_ciego_y_puerta_del_plan.sql — ANTES.
-- ⚠️ Revertir REABRE el `else` ciego: un sujeto sin rama vuelve a cancelar una
--    recurrencia de despensa ajena, con ok:true. Y deja a
--    confirmar_pago_plan_paseo SIN LLAMADOR — motor sin puerta.
BEGIN;
