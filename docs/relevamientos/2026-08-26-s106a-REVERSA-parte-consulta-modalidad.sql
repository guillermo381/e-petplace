-- ════════════════════════════════════════════════════════════════════════
-- REVERSA de `20260826430000_s106a_parte_consulta_modalidad.sql`
-- Escrita ANTES de aplicar. Cuerpo tomado del OBJETO, no transcrito a mano.
--
-- QUÉ DESHACE: saca la clave `modalidad` del parte de consulta.
-- ⚠️ QUÉ NO: nada de datos. Y si un bundle vivo ya la lee, revertir **borra
--    la marca de teleconsulta del parte sin error y sin síntoma** — la
--    consulta pasa a leerse como presencial. Es la firma §7 incumplida en
--    silencio, que es peor que un rojo.
-- ════════════════════════════════════════════════════════════════════════
