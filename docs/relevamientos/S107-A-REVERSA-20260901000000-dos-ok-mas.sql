/* ═══════════════════════════════════════════════════════════════════════════
   REVERSA de `20260901000000_s107a_dos_ok_mas.sql` — escrita ANTES.
   🔴 QUÉ NO DESHACE: revertir vuelve a reportar como `ok` **plata devuelta que
   no encontró su intento** y **plata que llegó por otro monto** — los dos
   estados que exigen intervención humana. *Un ok los hace invisibles.*
   ═══════════════════════════════════════════════════════════════════════════ */
BEGIN;
