/* ═══════════════════════════════════════════════════════════════════════════
   REVERSA de `20260831220000_s107a_sujeto_no_soportado.sql` — escrita ANTES.
   ═══════════════════════════════════════════════════════════════════════════
   🔴 QUÉ NO DESHACE: revertir devuelve el actuador al estado donde **un sujeto
   que no sabe mover se reporta como `ok: true` y el evento queda sin marca** —
   o sea, **un cobro que no ocurrió reportado como ocurrido**, y sin una columna
   que se pueda listar, contar ni alertar. *No devuelve eventos ya marcados: los
   `resultado='desconocido'` que se hayan escrito quedan, y está bien que
   queden.*
   ═══════════════════════════════════════════════════════════════════════════ */
BEGIN;
