/* ═══════════════════════════════════════════════════════════════════════════
   REVERSA de `20260831180000_s107a_tarjeta_del_mandato.sql` — escrita ANTES.
   ═══════════════════════════════════════════════════════════════════════════
   🔴 QUÉ NO DESHACE: revertir vuelve a permitir **firmar un mandato de cobro
   recurrente sobre una tarjeta `rechazada`, `abandonada` o VENCIDA** — y el
   día que el reloj se encienda, ese mandato intenta cobrar todos los meses
   contra un medio que no puede pagar. *No devuelve mandatos ya firmados: los
   que existan quedan.*
   ═══════════════════════════════════════════════════════════════════════════ */
BEGIN;
