-- REVERSA de 20260826050000_s105a_voz_del_reverso.sql
-- Escrita ANTES de aplicar.
-- QUÉ DESHACE: retira el caso `pago_reversado` de `_voz_notificacion` y
-- devuelve `mover_sujeto_por_reverso` a pasar sus textos inline.
-- 🔴 QUÉ NO DESHACE: los avisos YA registrados conservan el texto que
-- llevaban. Y el aviso vuelve a ser **español-only y fuera del único lugar
-- donde las voces se firman** — que es lo que esta migración cura.
