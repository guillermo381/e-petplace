-- REVERSA de 20260906220000_s109a_el_retorno_no_promete_saldo.sql — ANTES.
-- ⚠️ Revertir hace que la compra de paquete de paseo vuelva a AFIRMAR saldo y
--    fecha de pago sobre un bono que nace pendiente y no otorga nada.
BEGIN;
