-- REVERSA de 20260912140000. Restaura registrar/despachar sin multicanal y dropea la tabla.
-- NO deshace datos ya escritos en notificacion_entrega.
DROP TABLE IF EXISTS public.notificacion_entrega CASCADE;
