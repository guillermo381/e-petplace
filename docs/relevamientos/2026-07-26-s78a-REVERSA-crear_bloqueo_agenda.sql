-- REVERSA de la migracion S78-A5 (continuidad clinica > balanceo).
-- Es el cuerpo VIVO de crear_bloqueo_agenda leido con pg_get_functiondef
-- ANTES de aplicar, el 26-jul-2026.
--
-- NOTA HONESTA: revertir el CODIGO no revierte los DATOS. Las citas que
-- se hayan creado bajo el criterio de continuidad conservan la persona
-- que se les estampo; esta reversa solo restituye el criterio de reparto
-- para las citas FUTURAS.
