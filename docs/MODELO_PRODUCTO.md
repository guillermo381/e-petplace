...
> **Versión:** v1.4
> **Última actualización:** 16 Jul 2026 — Sesión 66. v1.4: enmienda founder a §2.5 "NO es un CRM veterinario" (el vet como cliente del software en gestión del negocio; segunda pregunta del criterio de prioridad). Referencia: `MODELO_VETERINARIA.md` v1.0 §15.2.
...
**Enmienda S66 (founder, `MODELO_VETERINARIA.md`):** el vet SÍ es cliente del software en las herramientas de GESTIÓN DEL NEGOCIO — cuando regalarlas asegura que el cobro pase por la plataforma. El criterio de prioridad suma una segunda pregunta: además de "¿enriquece el expediente?", vale "¿hace que cobrar adentro sea más fácil que afuera?". El espíritu original queda intacto: no vendemos licencias de CRM — las herramientas se regalan y la plataforma monetiza el flujo transaccional (precedente Fresha/Toast).
