...
| **`Isotipo dibujo="v5"`** | 🔴 **El isotipo del rediseño en el `Encabezado`** (`D-1110`, lote 9) — la marca más vista de la app: **sale en cuatro de las cinco tabs** y la montan 79 archivos del cliente. Se cambió **en la pieza**, no en las pantallas. ⚠️ **El default sigue siendo `'legado'` a propósito:** las **dos marcas de agua (210 y 1000)** llaman a la misma pieza, y *cambiar el default las habría movido de arrastre* — son otra decisión y de la mesa. Usa el mismo `d` que los ocho papeles, recortado a `ISOTIPO_V5_CAJA` (con el lienzo cuadrado, un isotipo de 32 px dibujaría 32 px de aire) |
